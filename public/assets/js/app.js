...
document.querySelector(window).addEventListener('load', function () {
    ...
    switch (body.attr('data-page')) {
        ...
        case "landing":
            ...
            introswiper.addEventListener('reachEnd', function () {
        ...
        case "index":
            ...
            document.querySelector('.hideonprogressbar').each(function () {
                var thisEl = document.querySelector(this);
                ...
                setInterval(function () {
                    ...
                    if (widthprogress > 0 && widthprogress < 100) {
                        thisEl.querySelector('.progress-bar').css('width', widthprogress + "%");

                    } else if (widthprogress === 100) {
                        document.querySelector(hidelment).fadeOut();
                    }
                }, 75)
        ...
        case 'stats':
            ...
            document.querySelector('.daterange-btn').addEventListener('click', function () {
                document.querySelector('#daterange').data('daterangepicker').toggle();
            });
            ...
            document.querySelector('.textdate').html(start.format('DD/MM/YYYY') + ' - ' + end.format('DD/MM/YYYY'));
            document.querySelector('#daterange').addEventListener('apply.daterangepicker', function (ev, picker) {
                document.querySelector('.textdate').text(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
            });
        ...
        case 'sendmoney1':
            ...
            document.querySelector('.cardswiper .swiper-slide .card').addEventListener('click', function () {
                document.querySelector('.cardswiper .swiper-slide .card').classList.remove('selected');
                document.querySelector(this).classList.add('selected').querySelector('.form-check-input').prop('checked', true);
            });
            break;
        case 'bills':
            /* swiper carousel connectionwiper */
        ...
        case 'chatmessage':
            ...
            document.querySelector('.videoplaybtn').addEventListener('click', function (e) {
                var videoPlayer = document.querySelector(this).parent().next('video');
                // Auto play, half volume.
                videoPlayer[0].play();
                videoPlayer.volume = 0.5;
                document.querySelector(this).parent().hide();
            })
        ...
        case 'blogs':
            document.querySelector(".sparklinechart").sparkline([5, 6, -7, 2, 0, -4, -2, 4], {
                type: 'bar',
                zeroAxis: false,
                barColor: '#3ac79b ',
                height: '30',
            });
            document.querySelector(".sparklinechart2").sparkline([-5, -6, 4, -2, 0, 4, 2, -4], {
                type: 'bar',
                zeroAxis: false,
                barColor: '#3ac79b ',
                height: '30',
